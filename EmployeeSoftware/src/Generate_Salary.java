...
@WebServlet("/servlet/Generate_Salary")
public class Generate_Salary extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		p.print("<form action='GenerateSalDB' method='post'>");
		...
		p.print("<center><input type='submit' name=s1 value='Generate Salary' class='btn btn-secondary mt-3'></center>");
		p.print("</div>");
		p.print("</div>");
		p.print("</form>");
