...
@WebServlet("/servlet/SalarySheetDB")
public class SalarySheetDB extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		p.print("<center><input type='submit' name=s1 value='Show Salary Sheet' class='btn btn-secondary mt-3'></center>");
		p.print("</div>");
		p.print("</div>");
		p.print("</form>");
		
		RequestDispatcher rd1=request.getRequestDispatcher("ShowSalarySheetDB");
